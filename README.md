...
- **Vite**: Hızlı geliştirme ve build araçları
- **Ant Design**: Profesyonel UI component kütüphanesi
- **React Router**: SPA routing yönetimi
- **CSS3**: Responsive tasarım ve animasyonlar

### **Backend**
- **Node.js**: Sunucu tarafı JavaScript runtime
- **Express.js**: Web framework ve API geliştirme
- **Sequelize ORM**: Veritabanı yönetimi ve modelleme
...
### **Geliştirme Araçları**
- **ESLint**: Kod kalitesi ve standardizasyon
- **Nodemon**: Otomatik sunucu yeniden başlatma
- **dotenv**: Çevre değişkenleri yönetimi
- **CORS**: Cross-origin resource sharing

### **API & Entegrasyon**
- **RESTful API**: Standart API mimarisi
- **File Upload**: Multer ile dosya yükleme
- **QR Code Generation**: Dinamik QR kod oluşturma
- **Excel Processing**: XLSX dosya işleme
...
### **Deployment**
- **Backend Service and Database**: Railway
- **Static Site**: Render
...
İlk giriş için varsayılan süper admin hesabı oluşturulacaktır.
...
│   │   ├── adminController.js    # Ürün & kategori yönetimi
│   │   ├── authController.js     # Kimlik doğrulama
│   │   ├── branchController.js   # Şube yönetimi
│   │   ├── labelController.js    # Etiket yönetimi
│   │   └── userController.js     # Kullanıcı yönetimi
│   ├── models/                   # Sequelize modelleri
│   │   ├── index.js              # Model ilişkileri
│   │   ├── User.js               # Kullanıcı modeli
│   │   ├── Products.js           # Ürün modeli
│   │   ├── Category.js           # Kategori modeli
│   │   ├── Label.js              # Etiket modeli
│   │   └── Branch.js             # Şube modeli
│   ├── middleware/               # Express middleware
│   │   └── authMiddleware.js     # Yetkilendirme
...
└── sample_products.sql           # 🗄️ Örnek veri SQL dosyası
```
...
### **Geliştirme Rehberi**
- Code style için ESLint kurallarına uyun
...
- Pull Request açmadan önce tüm testlerin geçtiğinden emin olun
...
- **Proje Sahibi**: [Ahmethulusi](https://github.com/Ahmethulusi)
- **Proje Linki**: [https://github.com/Ahmethulusi/QRMenu-App](https://github.com/Ahmethulusi/QRMenu-App)
...
<p align="center">
  <strong>QRMenu-App ile işletmenizi dijitalleştirin! 🚀</strong>
</p>
